# SAIR Modular Arithmetic Challenge Documentation

Welcome to the documentation root for the Modular Arithmetic Challenge. This repository is heavily documented to support long-term research.

## Reading Guide

To understand the project, we recommend reading the documents in the following order:

### 1. Repository Architecture & Design
Understand how this repository is structured and why.
